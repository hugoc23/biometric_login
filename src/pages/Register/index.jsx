  ...
  return (
    <>
      <div className="bg-gradient  flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-10 md:gap-10 items-start justify-between mx-auto md:pl-10 sm:pl-5 pl-[97px] w-full">
        ...
        <div className="bg-white-A700 flex flex-col items-start justify-center p-24 md:px-5 w-[41%] md:w-full">
          <Text
            className="mt-[155px] md:text-2xl sm:text-[22px] text-[26px] text-blue_gray-900"
          ...
          <Input
            ...
            wrapClassName="border border-gray-200 border-solid flex ml-5 md:ml-[0] mt-9 w-[86%]"
            prefix={
              <Img
          ...
          ></Input>
          <Button
            className="common-pointer cursor-pointer leading-[normal] mb-[156px] ml-2.5 md:ml-[0] mt-[39px] text-center text-sm w-[307px]"
            onClick={() => navigate("/registrodevoz")}
            shape="round"
          >
            Continuar
          </Button>
